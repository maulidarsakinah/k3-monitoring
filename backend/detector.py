...
# Severity mapping berdasarkan jumlah pelanggaran
# 1 pelanggaran = low, 2-3 = medium, 4+ = high
SEVERITY_LEVELS = {
    0: "none",
    1: "low",
    2: "medium",
...
def calculate_severity(violations: list[str]) -> str:
    """Hitung tingkat keparahan berdasarkan jumlah pelanggaran."""
...
class APDDetector:
    ...
    def _check_missing_apd(self, detections: list[Detection]) -> list[str]:
        ...
        any_apd_detected = any(
            d.category not in ("person", "objek", "unknown") for d in detections
        )
