        ...
        <div className="w-72 shrink-0 bg-white rounded-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="relative bg-[#0d1b2a] h-44 flex flex-col items-center justify-center gap-2 overflow-hidden">
            {selected.evidenceUrl ? (
              <button
                type="button"
                onClick={() => setPreviewImage(selected.evidenceUrl)}
              ...
              >
                ...
                />
                <span className="absolute right-3 top-3 rounded-lg bg-black/60 px-2.5 py-1 text-[10px] font-bold uppercase text-white opacity-0 transition group-hover:opacity-100">
                  Perbesar
                </span>
              </button>
            ) : (
